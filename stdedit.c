...
void master_menu(){
    ...
    mvwprintw(menu,1,1," OPTIONS:F1 | SAVE:F5 | EXIT:F2 | ^X:CUT | ^C:COPY | SUGGESTIONS:TAB | ALCHEMIST TEXT EDITOR | LINE NO.: %d | COORDINATES:(%d,%d)| #LINE:%d",y+stline+1,x,y,(y+stline)/10);
...
void self_destruct(){
    ...
    printf("\nThe Program terminated Successfully :)\nThanks For Using ALCHEMIST Text Editor\n\n");
    return;
}
